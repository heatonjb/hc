...
.. code-block:: bash
    ...
    heroku run python hc/manage.py syncdb --noinput --settings=config.settings
    heroku run python hc/manage.py migrate --settings=config.settings
    heroku run python hc/manage.py collectstatic --settings=config.settings
